"""
Django settings for CryptoQWeb project - Production version for Render deployment.

This file contains production settings with whitenoise and database URL support.
"""
...
# Add whitenoise for production if available
try:
    import whitenoise
...
# Static files storage for production (if whitenoise is available)
try:
    import whitenoise
